...
//       navigate(role === "ADMIN" ? "/AdminDashboard" : "/ScholarshipInfo"); // Redirect based on role
//     } catch (error) {
//       const message =
...
//   return (
//     <div className="min-h-screen bg-gradient-to-br from-blue-100 via-white to-blue-300 flex items-center justify-center px-4">
...
//             type="submit"
//             disabled={loading}
//             className={`w-full bg-blue-700 hover:bg-blue-800 text-white font-semibold py-3 rounded-lg shadow-lg transition duration-200 ${
